      ...
      <div className="space-y-6">
        <div className="p-4 rounded-xl bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm border border-white/50 dark:border-gray-700/50">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
            Fiat values are always shown on your balance and transaction history.
            Uses live price from CoinGecko or a custom rate.
          </p>
          <div className="space-y-4">
            <div>
              ...
              <select
                ...
                className="h-11 w-full max-w-xs rounded-lg border border-gray-200/60 dark:border-gray-600 bg-white/60 dark:bg-gray-800/60 px-3 py-2 text-sm text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-primary"
              >
