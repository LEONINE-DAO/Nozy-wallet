...
use crate::secret::transaction_history::{SecretTransactionStorage, SecretTransactionRecord, SecretTransactionStatus};
...
impl SecretWallet {
    ...
    pub async fn send_token(
        ...
        let tx_bytes = tx_builder.build_and_sign_transaction(
            key_pair,
            token_contract,
            recipient,
            amount_raw,
        ...
        let tx_hash = response.get("tx_response")
