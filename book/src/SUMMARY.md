...
- [Restoring from Seed Phrase](getting-started/restoring-wallet.md)
...
- [Receiving ZEC](user-guide/receiving-zec.md)
- [Transaction History](user-guide/transaction-history.md)
- [Address Management](user-guide/address-management.md)
- [Backup & Recovery](user-guide/backup-recovery.md)

# Desktop App

- [Installation](desktop-app/installation.md)
- [First-Time Setup](desktop-app/first-time-setup.md)
...
- [Transaction Commands](cli/transaction-commands.md)
- [Advanced Commands](cli/advanced-commands.md)
...
- [Wallet Endpoints](api/wallet-endpoints.md)
- [Transaction Endpoints](api/transaction-endpoints.md)
- [Address Endpoints](api/address-endpoints.md)
- [Balance & Sync Endpoints](api/balance-sync-endpoints.md)
- [Configuration Endpoints](api/config-endpoints.md)
- [Proving Parameters Endpoints](api/proving-endpoints.md)
